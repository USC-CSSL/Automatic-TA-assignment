			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				...
				<form method="post" action="user-add-personal-details-action.php">
				  <div class="form-row">
					...
					<select required type="text" class="form-control" name="area" id="area" placeholder="Area">
						<option>BCS</option>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-lg-6 col-sm-6 col-xs-6 col-md-6">
				    		...
				    		while($row = mysqli_fetch_array($result))
						{
							...
							{
								echo "<option value=".$row1['Section_Id'].">".$row['Course_Code']." Lecture Code ".$row1['Lecture_Code']."</option>";				
							}
 						}
